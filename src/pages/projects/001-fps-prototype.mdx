...
<img alt="A screenshot of a video game shotgun with debugging markings illustrating the trajectory of the gun's projectiles" src="/images/projects/fps-prototype/spread-sg.png" width="800" />
...
<div class="flexbox-vertical" style="gap: var(--spacing-6); margin-block-end: var(--spacing-6);">
  <div class="flexbox-horizontal flexbox-horizontal-blocks">
    <img alt="" src="/images/projects/fps-prototype/icon-mkb-1.png" width="240" />
    <img alt="" src="/images/projects/fps-prototype/icon-gamepad-1.png" width="240" />
  </div>

  <div class="flexbox-horizontal flexbox-horizontal-blocks">
    <img alt="" src="/images/projects/fps-prototype/icon-mkb-2.png" width="240" />
    <img alt="" src="/images/projects/fps-prototype/icon-gamepad-2.png" width="240" />
  </div>
</div>
